...
const DEFAULT_NODE_ENV = "production";//process.env.BUILD_MODULE ? "production" : process.env.NODE_ENV || "development";

const isDevelopment = false;//DEFAULT_NODE_ENV !== "production";
process.env.BUILD_NO_MINIMIZATION=true;
const BUILD = {
  NO_SERVER: true, //!!process.env.BUILD_NO_MINIMIZATION,
  NO_MINIMIZE: false, //isDevelopment || !!process.env.BUILD_NO_MINIMIZATION,
  NO_CHUNKS: false, //isDevelopment || !!process.env.BUILD_NO_CHUNKS,
  NO_HASH: false, //isDevelopment || process.env.BUILD_NO_HASH,
  MODULE: true, //!isDevelopment && !!process.env.BUILD_MODULE,
